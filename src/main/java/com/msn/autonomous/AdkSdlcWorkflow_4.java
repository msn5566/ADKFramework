...
// Google ADK Java Console App: Full SDLC Flow with Spring Boot Microservice Code Generation, File Output, Zip Packaging, Git Init, and GitHub Push
...
public class AdkSdlcWorkflow_4 {
...
""")
    ...
    public static void initGitRepo(String baseDir) {
        try {
            ...
            // Append branch info to README.md if exists
    ...
    public static void pushToGitHub(String baseDir, String repoUrl) {
        try {
            ...
            // Try opening the repo in browser

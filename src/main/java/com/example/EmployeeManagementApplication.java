  ...
  docker:
    ...
    steps:
      ...
      - name: Push Docker Image
        run: docker tag employee-management-image ${{ secrets.DOCKERHUB_USERNAME }}/employee-management-image:latest && docker push ${{ secrets.DOCKERHUB_USERNAME }}/employee-management-image:latest
```
